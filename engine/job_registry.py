...
JOBS: list[dict] = [
    ...
    {"id": "chartread_prewarm",  "label": "Expert Read Prewarm",    "cadence": INTRADAY, "schedule": "every 4 min, trading days", "category": "Quant",    "what": "Pre-warms the hub Expert Read (chart_read) for core tickers × 1D/1H so the timeframe toggle is instant."},
